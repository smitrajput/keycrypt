...
export default async function (hre: HardhatRuntimeEnvironment) {
	...
	const factoryArtifact = await deployer.loadArtifact('ZKS_Factory');
	const aaArtifact = await deployer.loadArtifact('ZKS_Keycrypt');
	...
	console.log(`ZKS_Factory address: ${factory.address}`);
	...
	// ZKS_Factory address: 0x771F394e184525dF90376C34922399Db2c4b504E, 0x7724153EF95B1dA3F2c770dC6BfE56626fe7d339, 0xA015E20967741f10D6aAfE71C85cf638430d20aB,
